...
import { getEnumValues, getEnums, getTableSchema, uniqueColumns, getConnectionParams } from '../helpers/utils';
...
export async function getMappingColumns(
	...
	const { db } = await configurePostgres.call(this, connectionParams);
